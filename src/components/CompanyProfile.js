  ...
  return (
    <div className="view-profile">
      ...
      <div>
        ...
        <h4>Social Media</h4>
        {companyInfo.socialMedia.linkedin && <p><strong>LinkedIn:</strong> <a href={companyInfo.socialMedia.linkedin} target="_blank" rel="noopener noreferrer">{companyInfo.socialMedia.linkedin}</a></p>}
        {companyInfo.socialMedia.facebook && <p><strong>Facebook:</strong> <a href={companyInfo.socialMedia.facebook} target="_blank" rel="noopener noreferrer">{companyInfo.socialMedia.facebook}</a></p>}
        {companyInfo.socialMedia.twitter && <p><strong>Twitter:</strong> <a href={companyInfo.socialMedia.twitter} target="_blank" rel="noopener noreferrer">{companyInfo.socialMedia.twitter}</a></p>}
        {companyInfo.socialMedia.instagram && <p><strong>Instagram:</strong> <a href={companyInfo.socialMedia.instagram} target="_blank" rel="noopener noreferrer">{companyInfo.socialMedia.instagram}</a></p>}
      </div>
      <div>
