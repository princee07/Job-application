  ...
  return (
    <div className="my-profile">
      ...
      <form onSubmit={handleSaveProfile}>
        ...
        <label>
          District
          <input type="text" name="district" value={companyInfo.district} onChange={handleInputChange} required />
        </label>
        <label>
          Email
        ...
        <label>
          LinkedIn
          <input type="text" name="socialMedia.linkedin" value={companyInfo.socialMedia.linkedin} onChange={handleInputChange} />
        </label>
        <label>
          Facebook
          <input type="text" name="socialMedia.facebook" value={companyInfo.socialMedia.facebook} onChange={handleInputChange} />
        </label>
        <label>
          Twitter
          <input type="text" name="socialMedia.twitter" value={companyInfo.socialMedia.twitter} onChange={handleInputChange} />
        </label>
        <label>
          Instagram
          <input type="text" name="socialMedia.instagram" value={companyInfo.socialMedia.instagram} onChange={handleInputChange} />
        </label>
